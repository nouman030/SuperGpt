...
function SideBar({ isMenuOpen, setIsMenuOpen }) {
  const { chats, selectedChat, setSelectedChat, user, theme, setTheme } =
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-gray-800 mt-auto">
        {user && (
          <div className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-600/30 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
